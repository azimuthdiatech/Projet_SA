...
<div id="menu_accueil">
    ...
    <div id="acc_body">
        ...
        <div id="acc_menu">
                ...
                <div id="menu">
                    <ul>
                        <li><a class="active" href="<?=WEB_PUBLIC."?controllers=user&action=#"?>">Liste Question</a><div id="acc_icone"><img src="<?=WEB_PUBLIC."img".DIRECTORY_SEPARATOR."ic-liste.png" ?>" class="img_acc" alt=""></div></li>
                        <li><a class="active" href="<?=WEB_PUBLIC."?controllers=user&action=#"?>">Creer Admin</a><div id="acc_icone"><img src="<?=WEB_PUBLIC."img".DIRECTORY_SEPARATOR."ic-ajout.png" ?>" class="img_acc" alt=""></div></li>
                        <?php if(is_admin()):?>
                        ...
                        <?php endif?>
                        <li><a class="active" href="<?=WEB_PUBLIC."?controllers=user&action=#"?>">Creer Question</a><div id="acc_icone"><img src="<?=WEB_PUBLIC."img".DIRECTORY_SEPARATOR."ic-ajout.png" ?>" class="img_acc" alt=""></div></li>
                    </ul>
                </div>
